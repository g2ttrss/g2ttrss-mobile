...
$(document).ready(function() {
    ...
    request.done(function (response, textStatus, jqXHR) {
        ...
        $.cookie('g2tt_sid',response['content'].session_id,{expires:7});
...
function getHeadlines(since) {
    ...
    $('.entry-header-body').unbind('click').click(function() {
        if($(this).closest('.entry-row').hasClass('expanded')) {return;}
...
function getTopCategories() {
    ...
    cats.done(function (response, textStatus, jqXHR) {
        ...
        cats.sort(function(a,b) { return ((a.order_id < b.order_id)?-1:((a.order_id > b.order_id)?1:0)); });
...
function getFeeds(parent_id, parent_title, parent_unread) {
    ...
    feeds.done(function (response, textStatus, jqXHR) {
        ...
        feeds.sort(function(a,b) { return ((a.cat_id < b.cat_id)?-1:((a.cat_id > b.cat_id)?1:0)); });
